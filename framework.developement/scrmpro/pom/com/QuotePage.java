...
public class QuotePage extends OppPage{
	...
	public static WebElement select_accountname_drpdwn;
	...
	public static WebElement select_quote_opp_drpdwn;
	
	@FindBy(id="ContentPlaceHolder1_AddQuote_ddlIndustryQuote")
	public static WebElement select_quoteindustry_drpdwn;
	
	@FindBy(id="ContentPlaceHolder1_AddQuote_ddlStatusCode")
	public static WebElement select_quotestatus_drpdwn;
	
	@FindBy(id="ContentPlaceHolder1_AddQuote_ddlPaymentTermCode")
	public static WebElement select_quote_paymentTerm_drpdwn;
	
	@FindBy(id="ContentPlaceHolder1_AddQuote_tbExpiresOn")
	public static WebElement Txt_Quote_ValidTill;
	
	@FindBy(id="ContentPlaceHolder1_AddQuote_ddlTransactionCurrency")
	public static WebElement select_quote_Currency_drpdwn;
...
//	public static WebElement tex_Quote_total_amount;
    ...
    public static WebElement select_currency_Drpdwn;
	...
	public static WebElement select_sddressName_Drpdwn;
	...
	public static List<WebElement> Clk_quoteList;
	
	
	@FindBy(id="ContentPlaceHolder1_ViewQuote1_lvQuote_tdEditQuote_0")
	public static List<WebElement> Clk_edit_icon;
	...
	public static List<WebElement> clk_delete_Icon;
...
//	public static WebElement chk_quote2;
	...
	public static WebElement select_quote_customView_drpdwn;		
...
public class QuotePage extends OppPage{
	...
	@FindBy(id="btnSave1")
	public static WebElement Clickon_ToDo_Save_btn1;
	
	@FindBy(id="btnSave1")
	public static WebElement Clickon_ToDo_Save_btn2;
	
	@FindBy(id="btnSave1")
	public static WebElement Clickon_ToDo_Save_btn3;
